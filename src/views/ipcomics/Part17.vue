    ...
    <div>
        <div class="section">
            ...
            <div v-show="lang === 'en'" style="padding-top: 50px">
                <img src="../../assets/comics/part17/ip1.png" width="100%">
                <img src="../../assets/comics/part17/ip2.png" width="100%">
                <img src="../../assets/comics/part17/ip3.png" width="100%">
                <img src="../../assets/comics/part17/ip4.png" width="100%">
                <img src="../../assets/comics/part17/ip5.png" width="100%">
                <img src="../../assets/comics/part17/ip6.png" width="100%">
            </div>

<template>
    <div>
        <div class="center">
            ...
            <div class="section2">
                {{$t("comparison.oilFilter.housing")}}
            </div>
            <div class="section1">
                <div class="content" :style="{'line-height' : (lang === 'en' ? '1.3': 'unset')}">
                    <div class="left">
            ...
            <div class="section2">
                {{$t("comparison.oilFilter.bypassValve")}}
            </div>
            <div class="section1">
                <div class="content" :style="{'line-height' : (lang === 'en' ? '1.3': 'unset')}">
                    <div class="left">
            ...
            <div class="section2">
                {{$t("comparison.oilFilter.filterPaper")}}
            </div>
            <div class="section1">
                <div class="content" :style="{'line-height' : (lang === 'en' ? '1.3': 'unset')}">
                    <div class="left">

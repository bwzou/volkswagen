<template>
    <div>
        <div class="center">
            ...
            <div class="section2">
                {{$t("comparison.airFilter.filterMedia")}}
            </div>
            <div class="section1">
                <div class="content" :style="{'line-height' : (lang === 'en' ? '1.3': 'unset')}">
                    <div class="left">
            ...
            <div class="section2">
                {{$t("comparison.airFilter.flameRetardantCoating")}}
            </div>
            <div class="section1">
                <div class="content" :style="{'line-height' : (lang === 'en' ? '1.3': 'unset')}">
                    <div class="left">
            ...
            <div class="section2">
                {{$t("comparison.airFilter.hotMeltAdhesive")}}
            </div>
            <div class="section1">
                <div class="content" :style="{'line-height' : (lang === 'en' ? '1.3': 'unset')}">
                    <div class="left">
            ...
            <div class="section2">
                {{$t("comparison.airFilter.housing")}}
            </div>
            <div class="section1">
                <div class="content" :style="{'line-height' : (lang === 'en' ? '1.3': 'unset')}">
                    <div class="left">
